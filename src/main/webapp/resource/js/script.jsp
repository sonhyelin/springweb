     ...
     //----노드복제 예제------------------
      ...
      window.addEventListener("load", function(){
          ...
          var data = [
              ...
              {id:"2", title:"자바스크립트", writerId:"newlec"},
              {id:"3", title:"둘다", writerId:"newlec"}
           ];
         ...
         // http://localhost/SpringWeb/resource/js/script.html
          //http://localhost/SpringWeb/customer/notice-ajax
